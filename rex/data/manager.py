...
class StreamTransformManager(object):
    def __init__(
        ...
        self.train_set = dataset_class(load_fn(train_filepath), transform, debug=debug_mode)
        self.dev_set = dataset_class(load_fn(dev_filepath), transform, debug=debug_mode)
        self.test_set = dataset_class(load_fn(test_filepath), transform, debug=debug_mode)
